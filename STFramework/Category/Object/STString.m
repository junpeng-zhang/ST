...
-(NSString*)firstCharUpper
{
    if(self.length>0)
    {
        if(self.length==0)
        {
            return [NSString stringWithFormat:@"%c",CharUpper([self characterAtIndex:0])];
        }
        return [NSString stringWithFormat:@"%c%@",CharUpper([self characterAtIndex:0]),[self substringFromIndex:1]];
    }
    return self;
}
-(NSString*)firstCharLower
{
    if(self.length>0)
    {
        if(self.length==0)
        {
            return [NSString stringWithFormat:@"%c",CharLower([self characterAtIndex:0])];
        }
        return [NSString stringWithFormat:@"%c%@",CharLower([self characterAtIndex:0]),[self substringFromIndex:1]];
    }
    return self;
}
@end

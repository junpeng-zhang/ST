...
//  TYSupervisor
//
//  Created by dingjianjaja  on 15/12/18.
//  Copyright © 2015年 dingjianjaja. All rights reserved.
//
...
{
    [self confirm:title msg:message click:click okButtonText:@"确定"];
}
-(void)confirm:(NSString *)title msg:(NSString *)message click:(OnClick)click okButtonText:(NSString*)okButtonText
{
    _click=click;
    if(_confirmView==nil)
    {
